...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Changed query to use employee table
        ...
        if ($result && $result->num_rows > 0) {
            ...
            // If the passwords are hashed in the database
            ...
            // If the passwords are stored as plain text (temporary, should be upgraded to hashed)
            ...
            <div class="login__content">
                ...
                <form id="loginForm" method="POST" class="login__form">
                    <div>
                        ...
                        <p class="login__description">Welcome! Please login to continue.</p>
                    </div>
